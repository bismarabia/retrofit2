 ...
 */
package systems.hotech.retrofit.okhttp3.internal.http;
...
import static systems.hotech.retrofit.okhttp3.internal.Util.EMPTY_HEADERS;
import static systems.hotech.retrofit.okhttp3.internal.http.StatusLine.HTTP_CONTINUE;
    ...
    private static void parseChallengeHeader(List<Challenge> result, Buffer header) {
        ...
        while (true) {
            ...
            if (!commaPrefixed && (commaSuffixed || header.exhausted())) {
                result.add(new Challenge(schemeName, Collections.<String, String>singletonMap(null, peek + repeat('=', eqCount))));
                peek = null;
                continue;
            }
