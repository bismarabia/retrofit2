 ...
 */
package systems.hotech.retrofit.okhttp3.internal.cache2;
...
/**
 * Read and write a target file. Unlike Okio's built-in {@linkplain Okio#source(File) file
 * source} and {@linkplain Okio#sink(File) file sink} this class offers:
 *
 * <ul>
