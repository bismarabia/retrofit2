...
import systems.hotech.retrofit.retrofit2.http.Field;
import systems.hotech.retrofit.retrofit2.http.Headers;
...
public final class Retrofit {
    ...
    final systems.hotech.retrofit.okhttp3.Call.Factory callFactory;
    ...
    Retrofit(systems.hotech.retrofit.okhttp3.Call.Factory callFactory, HttpUrl baseUrl,
    ...
    /**
     * The factory used to create {@linkplain systems.hotech.retrofit.okhttp3.Call OkHttp calls} for sending a HTTP requests.
     * Typically an instance of {@link OkHttpClient}.
     */
    public systems.hotech.retrofit.okhttp3.Call.Factory callFactory() {
        return callFactory;
    }
    ...
    public static final class Builder {
        ...
        private @Nullable
        systems.hotech.retrofit.okhttp3.Call.Factory callFactory;
        private @Nullable
        HttpUrl baseUrl;
        ...
        Builder(Retrofit retrofit) {
            ...
            for (int i = 1,
                 ...
                 i < size; i++) {
                converterFactories.add(converterFactories.get(i));
            }
            ...
            for (int i = 0,
                 ...
                 i < size; i++) {
                callAdapterFactories.add(callAdapterFactories.get(i));
            }
         ...
         */
        public Builder callFactory(systems.hotech.retrofit.okhttp3.Call.Factory factory) {
        ...
        public Retrofit build() {
            ...
            systems.hotech.retrofit.okhttp3.Call.Factory callFactory = this.callFactory;
            if (callFactory == null) {
