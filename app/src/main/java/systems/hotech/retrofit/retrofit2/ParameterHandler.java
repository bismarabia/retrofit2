...
abstract class ParameterHandler<T> {
    ...
    static final class Headers extends ParameterHandler<systems.hotech.retrofit.okhttp3.Headers> {
        private final Method method;
        private final int p;
        ...
        @Override
        void apply(RequestBuilder builder, @Nullable systems.hotech.retrofit.okhttp3.Headers headers) {
            if (headers == null) {
    ...
    static final class Part<T> extends ParameterHandler<T> {
        private final Method method;
        private final int p;
        private final systems.hotech.retrofit.okhttp3.Headers headers;
        private final Converter<T, RequestBody> converter;

        Part(Method method, int p, systems.hotech.retrofit.okhttp3.Headers headers, Converter<T, RequestBody> converter) {
            this.method = method;
            this.p = p;
    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        void apply(RequestBuilder builder, @Nullable Map<String, T> value)
            ...
            for (Map.Entry<String, T> entry : value.entrySet()) {
                ...
                systems.hotech.retrofit.okhttp3.Headers headers = systems.hotech.retrofit.okhttp3.Headers.of(
