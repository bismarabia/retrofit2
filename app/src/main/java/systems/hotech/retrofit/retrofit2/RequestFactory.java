...
import systems.hotech.retrofit.okhttp3.Headers;
...
import static systems.hotech.retrofit.retrofit2.Utils.*;
...
final class RequestFactory {
    ...
    systems.hotech.retrofit.okhttp3.Request create(Object[] args) throws IOException {
...
//            }
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                ...
                parseHttpMethodAndPath("GET", ((GET) annotation).value(), true);
            }
            ...
            else if (annotation instanceof systems.hotech.retrofit.retrofit2.http.Headers) {
                String[] headersToParse = ((systems.hotech.retrofit.retrofit2.http.Headers) annotation).value();
